...
class AddClinicManagePage extends StatefulWidget {
  const AddClinicManagePage({super.key});

  @override
  State<AddClinicManagePage> createState() => _AddClinicManagePageState();
}

class _AddClinicManagePageState extends State<AddClinicManagePage> {
